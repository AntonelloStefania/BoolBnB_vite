                    ...
                    <form @submit.prevent="sendForm()">
                            <div class="col_2">
                                <div class="name">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" placeholder=""
                                        aria-describedby="helpId" required v-model="name" :class="errors.name ? 'is-invalid' : '' ">
                                    <div class="alert alert-danger" role="alert" v-for="(error,index) in errors.name" :key="index">
                                        {{ error }}
                                    </div>
                                </div>
                                <div class="surname">
                                    ...
                                    <input type="text" name="surname" id="surname" class="form-control" placeholder=""
                                        aria-describedby="helpId" required v-model="surname" :class="errors.surname ? 'is-invalid' : '' ">
                                    <div class="alert alert-danger" role="alert" v-for="(error,index) in errors.surname" :key="index">
                                        {{ error }}
                                    </div>
                                </div>
                            </div>
                            <div class="email">
                                ...
                                <input type="email" name="email" id="email" class="form-control" placeholder=""
                                    aria-describedby="helpId" required v-model="email" :class="errors.email ? 'is-invalid' : '' ">
                                <div class="alert alert-danger" role="alert" v-for="(error,index) in errors.email" :key="index">
                                    {{ error }}
                                </div>
                            </div>
                            <div class="message">
                                ...
                                <textarea rows="3" cols="50" name="message" id="message" class="form-control" placeholder=""
                                    aria-describedby="helpId" required v-model="message" :class="errors.message ? 'is-invalid' : '' ">
                                </textarea>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          
                                <div class="alert alert-danger" role="alert" v-for="(error,index) in errors.message" :key="index">
                                    {{ error }}
                                </div>
                            </div>
